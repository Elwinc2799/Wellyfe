...
class FatigueLevelBarChart extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _FatigueLevelBarChartState();
}

class _FatigueLevelBarChartState extends State<FatigueLevelBarChart> {
  int touchedIndex = -1;
